...
package com.latdata.collect.sink;
...
import static com.latdata.collect.sink.KafkaSinkConstants.BOOTSTRAP_SERVERS_CONFIG;
import static com.latdata.collect.sink.KafkaSinkConstants.BATCH_SIZE;
import static com.latdata.collect.sink.KafkaSinkConstants.DEFAULT_BATCH_SIZE;
import static com.latdata.collect.sink.KafkaSinkConstants.BROKER_LIST_FLUME_KEY;
import static com.latdata.collect.sink.KafkaSinkConstants.DEFAULT_ACKS;
import static com.latdata.collect.sink.KafkaSinkConstants.DEFAULT_KEY_SERIALIZER;
import static com.latdata.collect.sink.KafkaSinkConstants.DEFAULT_TOPIC;
import static com.latdata.collect.sink.KafkaSinkConstants.DEFAULT_VALUE_SERIAIZER;
import static com.latdata.collect.sink.KafkaSinkConstants.KAFKA_PRODUCER_PREFIX;
import static com.latdata.collect.sink.KafkaSinkConstants.KEY_HEADER;
import static com.latdata.collect.sink.KafkaSinkConstants.OLD_BATCH_SIZE;
import static com.latdata.collect.sink.KafkaSinkConstants.REQUIRED_ACKS_FLUME_KEY;
import static com.latdata.collect.sink.KafkaSinkConstants.TOPIC_CONFIG;
import static com.latdata.collect.sink.KafkaSinkConstants.TOPIC_HEADER;
import static com.latdata.collect.sink.KafkaSinkConstants.KEY_SERIALIZER_KEY;
import static com.latdata.collect.sink.KafkaSinkConstants.MESSAGE_SERIALIZER_KEY;
...
public class KafkaSink extends AbstractSink implements Configurable {
  ...
  private byte[] serializeEvent(Event event, boolean useAvroEventFormat) throws IOException {
	...
	if(writeBody) {
		...
		strHeaders = mapper.writeValueAsString(event.getHeaders());
	        logger.debug("strHeaders: {}", strHeaders);
		event.setBody((strHeaders+"||"+strBody).getBytes());
	}
        bytes = event.getBody();
    }
    return bytes;
